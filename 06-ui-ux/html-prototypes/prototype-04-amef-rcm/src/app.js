(function(){
  ...
  function applyReadOnly(){var readonly=state.analysisHeader.status==="Publicada";document.body.classList.toggle("readonly-mode",readonly);if(!readonly)return;Array.prototype.forEach.call(document.querySelectorAll("#viewHost input,#viewHost select,#viewHost textarea,#viewHost button"),function(control){if(control.id!=="createRevision"&&!control.hasAttribute("data-review-tab")&&!control.hasAttribute("data-rules"))control.disabled=true;});}
